        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white py-3">
                    <h5 class="fw-bold mb-0" style="color: #550000;"><i class="bi bi-pencil-square me-2"></i>Edit Produk</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.produk.update', $produk->id_barang) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Nama Barang</label>
                            <input type="text" name="nama_barang" class="form-control" value="{{ $produk->nama_barang }}" required>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Harga Jual (Rp)</label>
                                <input type="number" name="harga_barang" class="form-control" value="{{ $produk->harga_barang }}" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label fw-semibold">Jumlah Stok</label>
                                <input type="number" step="any" name="jumlah_stok" class="form-control" value="{{ $stokAngka }}" required>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            @if($produk->gambar_barang)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $produk->gambar_barang) }}" alt="Preview" style="height: 70px; border-radius: 6px;">
                                </div>
                            @endif
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn text-white px-4 fw-semibold" style="background-color: #550000;">Simpan Perubahan</button>
                        </div>
                    </form>
                </div>
            </div>
